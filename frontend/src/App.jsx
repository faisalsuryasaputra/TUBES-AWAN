...
import { getRooms, getReservations, createReservation, deleteReservation } from './services/api';
...
function App() {
  ...
  const handleBooking = async (e) => {
    ...
    try {
      ...
      alert("Terjadi kesalahan saat meminjam ruangan.");
    }
  };
      ...
      <div className="max-w-6xl mx-auto space-y-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          ...
          <div className="bg-white p-6 rounded-lg shadow-sm border border-slate-200">
            <h2 className="text-xl font-bold text-slate-800 mb-4">Buat Peminjaman</h2>
